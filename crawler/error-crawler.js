...
async function accessSafePage() {
  ...
  await page.setUserAgent("Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0)");

  await page.setCookie({
    name: "userData",
    value: JSON.stringify({ isTouchable: true, isHeadless: true, isMobileResolution: true }),
